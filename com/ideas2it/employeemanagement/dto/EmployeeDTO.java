...
/**
 * Contains Private Variables of Employees with Details like
...
public class EmployeeDTO {
     ...
     *  parameterized constructor.
     */
    public EmployeeDTO(int id, String name, String mailId,
            long contactNumber, double salary, LocalDate birthDate, List<ProjectDTO> projectList) {
        this.employeeId = id;
        this.employeeName = name;
        this.employeeMailId = mailId;
        this.employeeContactNumber = contactNumber;
